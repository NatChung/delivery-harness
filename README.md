...
以 full track 為例,產物逐段交棒:Phase 1 brainstorming 產 **design.md** 指導 prototype → 客戶在 prototype 定案後,**spec.md** 寫 AC/BDD+TestID(含 mock,出場抽 mock 立 RED)→ 交給 implement 的 superpowers TDD 跑 red→green。
